// Based on: https://github.com/opencv/opencv/blob/master/modules/java/generator/android-21/java/org/opencv/android/JavaCamera2View.java
...
public class JavaCamera2View extends CameraBridgeViewBase {
    ...
    protected boolean initializeCamera() {
        ...
        try {
            ...
            if (mCameraIndex == CameraBridgeViewBase.CAMERA_ID_ANY || isEmulator()) { // Just open any camera on emulators
                mCameraID = camList[0];
            } else {
